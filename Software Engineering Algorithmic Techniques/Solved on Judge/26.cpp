...
//para que no quede ningun hueco en la calle. Para ello empieza por el restaurante j = i + 1 (siendo i el
...
//El coste de esta funcion es del orden del numero de restaurantes, O(n), ya que por cada restaurante recorre
//todos los siguientes que enlazan con este y se queda con el indice del mayor de ellos, para saltarse los ya
//recorridos y comenzar por ese ultimo en las sucesivas iteraciones.
//Sin embargo, ya que ordenamos el vector de restaurantes antes de entrar en esta funcion, el orden sera del
//orden de O(n * (log n)) siendo n el numero de restaurantes.
