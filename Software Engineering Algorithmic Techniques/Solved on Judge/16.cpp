...
public:
	//El coste de esta función es el del algoritmo de Prim, ya que guardamos en coste total en una variable para no tener que recorrer el vector 
	//y sacar el coste total, por lo que esta función tiene coste O(E * log(V))
