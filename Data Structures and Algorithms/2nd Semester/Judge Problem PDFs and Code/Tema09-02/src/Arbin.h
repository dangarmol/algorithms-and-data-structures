...
public:
	...
	*/
	...
	void fronteras(vector<T> &frontera, const T &vacio)
	{
		if(!esVacio())
			fronteras(_ra, frontera, vacio);
	}
...
protected:
	...
	static void fronteras(Nodo *ra, vector<T> &frontera, const T &vacio)
	{
		if(ra->_iz != NULL && ra->_dr != NULL)
		{
			fronteras(ra->_iz, frontera, vacio);
			fronteras(ra->_dr, frontera, vacio);
		}
		else if(ra->_iz != NULL)
		{
			fronteras(ra->_iz, frontera, vacio);
